...
```
Interpreting our results we see that the best two element models is using Length 1 and Length 3. The best overall model is the 5 element model using adjusted R squared R squared. 
