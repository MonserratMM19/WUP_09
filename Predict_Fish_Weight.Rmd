...
Interpreting our results we see that the best two element models is using height and width. The best overall model is also the 2 element model using height and width using adjusted R squared R squared. 
...
```
Interpreting our results we see that the best two element models is using Length 3 and width. The best overall model is the 2 element model using Length 3 and width using adjusted R squared.


## Final Summary Statements

I learned hoe to use leaps and learned how to start codes from scratch removing statements until I got the best adjusted R squared model. 
